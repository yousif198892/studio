...
export default function StudentMessagesPage() {
    ...
    if (userId) {
      ...
      if (currentStudent?.supervisorId) {
        ...
        if (currentSupervisor) {
          const studentMessages = getSupervisorMessagesForStudent(
            userId,
  ...
  const handleSendMessage = () => {
    ...
    const updatedMessages = getSupervisorMessagesForStudent(
      userId,
      supervisor.id
    );
      ...
      return (
         <div className="flex flex-col h-full items-center justify-center">
            ...
            <p className="text-muted-foreground mt-4">
                You are not assigned to a supervisor and cannot use the chat.
            </p>
         </div>
      )
  }
        ...
        <div className="flex flex-col border-r">
          ...
          <ScrollArea className="flex-1">
            <CardContent className="p-2">
              <button
                className={cn(
                  "flex items-center gap-3 text-left p-2 rounded-lg w-full bg-secondary"
                )}
              >
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              This will permanently delete this message. This
