...
// The `id` field is now omitted because it will be generated by Firebase Auth.
...
export const mockUsers: Omit<User, 'id'>[] = [
  ...
  },
  {
    ...
    role: "student",
    supervisorId: "sup1", // This will need to be updated post-seeding if IDs change
...
export const mockWords: Word[] = [
    {
        ...
        correctOption: "Apple",
        supervisorId: "sup1", // This may need updating post-seeding
    },
    {
        id: "word2",
        word: "Book",
